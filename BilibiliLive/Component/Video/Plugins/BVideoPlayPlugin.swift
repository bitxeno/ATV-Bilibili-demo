...
class BVideoPlayPlugin: NSObject, CommonPlayerPlugin {
    ...
    func playerDidDismiss(playerVC: AVPlayerViewController) {
        ...
        WebRequest.reportWatchHistory(aid: playData.aid, cid: playData.cid, currentTime: Int(currentTime), epid: playData.epid, seasonId: playData.seasonId, isBangumi: playData.isBangumi, bangumiType: playData.bangumiType?.rawValue)
    }
